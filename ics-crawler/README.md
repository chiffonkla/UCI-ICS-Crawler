# ICS Crawler
Develop a functional and polite Web crawler that exclusively targets pages within four specific UCI domains: 
*.ics.uci.edu/*, *.cs.uci.edu/*, *.informatics.uci.edu/*, and *.stat.uci.edu/*
